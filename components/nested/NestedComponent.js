...
function (_BaseComponent) {
  ...
  _createClass(NestedComponent, [{
    ...
    key: "checkConditions",
    value: function checkConditions(data, count, source) {

      this.getComponents().forEach(function (comp) {
        comp.checkConditions(data, count, source);
      });
      return _get(_getPrototypeOf(NestedComponent.prototype), "checkConditions", this).call(this, data, count, source);
    }
  }, {
    key: "clearOnHide",
